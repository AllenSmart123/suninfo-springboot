...
public class CodeResourceUtil {
	...
	private static final ResourceBundle bundlePath = ResourceBundle.getBundle( "autocode/cengle_config" );

	public static String DIVER_NAME = "com.mysql.jdbc.Driver";

	public static String URL = "jdbc:mysql://192.168.212.45:3306/imp_commondb?useUnicode=true&characterEncoding=UTF-8";

	public static String USERNAME = "root";

	public static String PASSWORD = "123456";

	public static String DATABASE_NAME = "imp_commondb";
	...
	public static String test_root_package = "test";
	...
	// public static String PAGE_URL = source_root_package + "/" +
	// bussiPackageUrl + "/" + page_package + "/";
	...
	static {
		...
		resource_root_package = getRsourceRootPackage();
	...
	// return bundle.getString( "jdbc.driverClassName" );
	// }
	//
	// public static final String getURL() {
	// return bundle.getString( "jdbc.url" );
	// }
	//
	// public static final String getUSERNAME() {
	// return bundle.getString( "jdbc.username" );
	// }
	//
	// public static final String getPASSWORD() {
	// return bundle.getString( "jdbc.password" );
	// }
	//
	...
	public static final String getRsourceRootPackage() {
